...
public class BookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] asal = {"Jakarta", "Bandung", "Makassar", "Yogyakarta", "Ambon"};
        final String[] tujuan = {"Jakarta", "Bandung", "Makassar", "Yogyakarta", "Ambon"};
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("Jakarta") && sTujuan.equalsIgnoreCase("Jakarta"))
                            ...
                            || (sAsal.equalsIgnoreCase("Ambon") && sTujuan.equalsIgnoreCase("Ambon"))) {
...
//    }
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("Jakarta") && sTujuan.equalsIgnoreCase("bandung")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("Jakarta") && sTujuan.equalsIgnoreCase("Ambon")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("Jakarta") && sTujuan.equalsIgnoreCase("Makassar")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
            ...
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("Bandung") && sTujuan.equalsIgnoreCase("Ambon")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("Bandung") && sTujuan.equalsIgnoreCase("Makassar")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("Bandung") && sTujuan.equalsIgnoreCase("Yogyakarta")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("Ambon") && sTujuan.equalsIgnoreCase("Jakarta")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("Ambon") && sTujuan.equalsIgnoreCase("Bandung")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("Ambon") && sTujuan.equalsIgnoreCase("Makassar")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("Ambon") && sTujuan.equalsIgnoreCase("Yogyakarta")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("Makassar") && sTujuan.equalsIgnoreCase("Jakarta")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("Makassar") && sTujuan.equalsIgnoreCase("Bandung")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("Makassar") && sTujuan.equalsIgnoreCase("Yogyakarta")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("Makassar") && sTujuan.equalsIgnoreCase("Ambon")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
            ...
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("yogyakarta") && sTujuan.equalsIgnoreCase("Makassar")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("yogyakarta") && sTujuan.equalsIgnoreCase("Ambon")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        }
